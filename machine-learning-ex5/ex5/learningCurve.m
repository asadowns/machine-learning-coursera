...
%! et_expected = [0.000000 0.031250 0.013333 0.005165 0.002268]';
%! ev_expected = [3.0000e-002 5.3125e-003 6.0000e-004 9.2975e-005 2.2676e-005]';
%! assert(et, et_expected, 0.0001);
%! assert(ev, ev_expected, 0.0001);